...
func _draw():
	...
	draw_circle(Vector2(0, length - shrinkage), size/2, Color(1,1,1));
	draw_circle(Vector2(0, length - shrinkage), size/2 + 5, Color(red + 0.3, green + 0.3, blue + 0.3, (sin(progress * 2 * PI * 25)+1)/2.0));
